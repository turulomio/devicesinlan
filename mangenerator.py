...
if __name__ == "__main__":
    ...
    man.paragraph(QCoreApplication.translate("mangenerator","Gives debugging information when running DevicesInLAN. It's deactivated by default"), 3)
    man.paragraph(QCoreApplication.translate("mangenerator","The parameter can take this options: CRITICAL, ERROR, WARNING, INFO, DEBUG."), 3)
